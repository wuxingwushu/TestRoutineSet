...
int main(int argc, char* argv[])
{
	...
	TinyMidiLoader = tml_load_filename("夜に駆ける.mid");
	if (!TinyMidiLoader)
	{
	...
	tsf_channel_set_bank_preset(g_TinySoundFont, 1, 256, 0);
	...
	std::cout << "channel:				" << g_MidiMessage->channel << std::endl;
	std::cout << "channel_pressure:		" << g_MidiMessage->channel_pressure << std::endl;
	std::cout << "control:				" << g_MidiMessage->control << std::endl;
	std::cout << "control_value:		" << g_MidiMessage->control_value << std::endl;
	std::cout << "key:					" << g_MidiMessage->key << std::endl;
	std::cout << "key_pressure:			" << g_MidiMessage->key_pressure << std::endl;
	std::cout << "next:					" << g_MidiMessage->next << std::endl;
	std::cout << "pitch_bend:			" << g_MidiMessage->pitch_bend << std::endl;
	std::cout << "program:				" << g_MidiMessage->program << std::endl;
	std::cout << "time:					" << g_MidiMessage->time << std::endl;
	//std::cout << "type:					" << g_MidiMessage->type << std::endl;
	std::cout << "velocity:				" << g_MidiMessage->velocity << std::endl;
	std::cout << "------------------------------------------------------------------" << std::endl;
