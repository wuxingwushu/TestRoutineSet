...
private:
    ...
    // 在以 node为根的二分搜索树中 删除 指定键值的节点
    // 并且返回 删除掉 指定键值节点后的 新的根
...
//            // 复制一份这个节点
//            predecessor = new Node(predecessor);
//            // 删除原版的这个节点
